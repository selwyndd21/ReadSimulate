...
int main(int argc, char** argv )
{
  ...
  {
    cout << "Comment: default output is set to output_3DVOI.txt" << endl;
    line="output_3DVOI.txt";
  }
  else if ( argc > 2 )
  {
    line=argv[2];
  ...
  out_file << endl << endl << endl;
  out_file << "Print Material Card for MAVRIC" << endl;
  t=0;
  for (k=25; k > 0; k--)
  {
    for (j=0; j< 11; j++)
    {
      ...
      {
        coredata_itr = 484*(k-1) + 22*j + i;
        tmp_flt = tmp_data[coredata_itr]; // locate Void fraction
        cout << "\' fuel assembly " << t+1 << endl;
        cout << " u-235  " << setw(5) << t+1 << " 0 6.449e-05 300   end" << endl;
        cout << " u-238  " << setw(5) << t+1 << " 0 5.205e-03 300   end" << endl;
        cout << " zr     " << setw(5) << t+1 << " 0 6.260E-03 300   end" << endl;
        cout << " Sn     " << setw(5) << t+1 << " 0 7.099E-05 300   end" << endl;
        cout << " Fe     " << setw(5) << t+1 << " 0 1.722E-05 300   end" << endl;
        cout << " Cr     " << setw(5) << t+1 << " 0 1.118E-05 300   end" << endl;
        cout << " Ni     " << setw(5) << t+1 << " 0 3.235E-06 300   end" << endl;
        cout << " Hf     " << setw(5) << t+1 << " 0 3.257E-07 300   end" << endl;
        cout << " o      " << setw(5) << t+1 << " 0 1.525e-02 300   end" << endl;
        cout << " h      " << setw(5) << t+1 << " 0 8.844e-03 300   end" << endl;
        t++;
      }
    }
  }
